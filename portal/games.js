globalThis.MINI_GAME_PORTAL_GAMES = [
  ...
  },
  {
    ...
    "category": "action",
    "categoryLabel": "ACTION",
    "description": "高速プラットフォームバトル。別リポジトリで本体を開発・配信します。",
    "searchTerms": ["skybreak", "platform fighter", "action", "対戦", "格闘", "アクション"],
    "icon": "./games/action/skybreak/icon.svg",
    "entry": "./index.html",
    "available": true,
    "path": "./games/action/skybreak/",
    "localEntry": "./games/action/skybreak/index.html",
    "assets": ["./games/action/skybreak/icon.svg", "./games/action/skybreak/index.html"]
  },
  {
    "schemaVersion": 1,
    "id": "marubatsu",
